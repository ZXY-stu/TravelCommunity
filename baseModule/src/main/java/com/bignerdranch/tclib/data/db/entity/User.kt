...
data class User(
    ...
    @ColumnInfo(name="id") val userId:Int=0,
    @ColumnInfo(name = "nick_name") val nickName:String="杀猪饲料",   //昵称
    ...
    val stat:Int = 0,   //0表示在线  1表示下线
    val lastLoginTime:String = "", //最后登录时间
    val isMember:Int = 0,  //普通设置为0 达人设置为1
    val privateModel:Int = 0, //隐私模式
