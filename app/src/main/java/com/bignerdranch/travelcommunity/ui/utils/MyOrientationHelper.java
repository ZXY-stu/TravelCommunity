...
public  abstract  class MyOrientationHelper {
 ...
 */
    ...
    static final Rect mTmpRect = new Rect();



    protected MyOrientationHelper(RecyclerView.LayoutManager mLayoutManager) {
     ...
     */
    public static MyOrientationHelper createOrientationHelper(
     ...
     * @return A new OrientationHelper
     */
    public static MyOrientationHelper createHorizontalHelper(
            RecyclerView.LayoutManager layoutManager) {
        return new MyOrientationHelper(layoutManager) {
            @Override
     ...
     * @return A new OrientationHelper
     */
    public static MyOrientationHelper createVerticalHelper(RecyclerView.LayoutManager layoutManager) {
        return new MyOrientationHelper(layoutManager) {
            @Override
            public int getEndAfterPadding() {
