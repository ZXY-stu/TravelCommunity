...
public class VideoPageSnapHelper extends MySnapHelper {
    private static final int MAX_SCROLL_ON_FLING_DURATION = 100; // ms

    // Orientation helpers are lazily created per LayoutManager.
    @Nullable
    private MyOrientationHelper mVerticalHelper;
    @Nullable
    private MyOrientationHelper mHorizontalHelper;
    ...
    public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager, int velocityX,
        ...
        final MyOrientationHelper orientationHelper = getOrientationHelper(layoutManager);
    ...
    private int distanceToCenter(@NonNull RecyclerView.LayoutManager layoutManager,
                                 @NonNull View targetView, MyOrientationHelper helper) {
    ...
    @Nullable
    private MyOrientationHelper getOrientationHelper(RecyclerView.LayoutManager layoutManager) {
        if (layoutManager.canScrollVertically()) {
    ...
    @NonNull
    private MyOrientationHelper getVerticalHelper(@NonNull RecyclerView.LayoutManager layoutManager) {
        if (mVerticalHelper == null || mVerticalHelper.mLayoutManager != layoutManager) {
            mVerticalHelper = MyOrientationHelper.createVerticalHelper(layoutManager);
        }
        return mVerticalHelper;
    }

    @NonNull
    private MyOrientationHelper getHorizontalHelper(
            @NonNull RecyclerView.LayoutManager layoutManager) {
        if (mHorizontalHelper == null || mHorizontalHelper.mLayoutManager != layoutManager) {
            mHorizontalHelper = MyOrientationHelper.createHorizontalHelper(layoutManager);
        }
