...
public abstract class MySnapHelper extends RecyclerView.OnFlingListener {

    static final float MILLISECONDS_PER_INCH = 100f;

    RecyclerView mRecyclerView;
    private Scroller mGravityScroller;
    private ScrollPlayListener playListener;
    public interface ScrollPlayListener{
        void play(int position);
    }

    public MySnapHelper setScrollPlayListener(ScrollPlayListener playListener){
     ...
     *
     */
    public MySnapHelper attachToRecyclerView(@Nullable RecyclerView recyclerView)
    ...
    private boolean snapFromFling(@NonNull RecyclerView.LayoutManager layoutManager, int velocityX,
        ...
        if(playListener!=null) playListener.play(targetPosition);
        return true;
    }
