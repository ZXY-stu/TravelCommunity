...
/**
 * {@link com.bignerdranch.travelcommunity.videocache.file.DiskUsage} that uses LRU (Least Recently Used) strategy to trim cache.
 *
...
public abstract class LruDiskUsage implements DiskUsage {
    ...
    private void touchInBackground(File file) throws IOException {
        com.bignerdranch.travelcommunity.videocache.file.Files.setLastModifiedNow(file);
        List<File> files = com.bignerdranch.travelcommunity.videocache.file.Files.getLruListFiles(file.getParentFile());
        trim(files);
    }
