...
import com.bignerdranch.travelcommunity.videocache.HttpUrlSource;
...
import static com.bignerdranch.travelcommunity.videocache.Preconditions.checkArgument;
...
class Pinger {
    ...
    private boolean pingServer() throws ProxyCacheException {
        ...
        try {
          ...
          //  LogUtil.INSTANCE.ee("ping" + pingUrl);
