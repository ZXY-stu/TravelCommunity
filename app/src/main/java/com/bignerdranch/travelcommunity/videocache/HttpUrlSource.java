...
import com.bignerdranch.travelcommunity.videocache.InterruptedProxyCacheException;
import com.bignerdranch.travelcommunity.videocache.ProxyCache;
import com.bignerdranch.travelcommunity.videocache.ProxyCacheException;
import com.bignerdranch.travelcommunity.videocache.ProxyCacheUtils;
import com.bignerdranch.travelcommunity.videocache.Source;
...
/**
 * {@link com.bignerdranch.travelcommunity.videocache.Source} that uses http resource as source for {@link com.bignerdranch.travelcommunity.videocache.ProxyCache}.
 *
...
public class HttpUrlSource implements Source {
    ...
    private com.bignerdranch.travelcommunity.videocache.SourceInfo sourceInfo;
    ...
    public HttpUrlSource(String url, SourceInfoStorage sourceInfoStorage, HeaderInjector headerInjector) {
        ...
        com.bignerdranch.travelcommunity.videocache.SourceInfo sourceInfo = sourceInfoStorage.get(url);
        this.sourceInfo = sourceInfo != null ? sourceInfo :
                new com.bignerdranch.travelcommunity.videocache.SourceInfo(url, Integer.MIN_VALUE, ProxyCacheUtils.getSupposablyMime(url));
    }
    ...
    public void open(long offset) throws ProxyCacheException {
        try {
            ...
            this.sourceInfo = new com.bignerdranch.travelcommunity.videocache.SourceInfo(sourceInfo.url, length, mime);
    ...
    private HttpURLConnection openConnection(long offset, int timeout) throws IOException, ProxyCacheException {
        ...
        do {
         //   LogUtil.INSTANCE.ee("Open connection " + (offset > 0 ? " with offset " + offset : "") + " to " + url);
