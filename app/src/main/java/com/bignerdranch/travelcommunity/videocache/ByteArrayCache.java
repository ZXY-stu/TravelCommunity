...
/**
 * Simple memory based {@link com.bignerdranch.travelcommunity.videocache.Cache} implementation.
 *
...
public class ByteArrayCache implements Cache {
    ...
    public ByteArrayCache(byte[] data) {
        this.data = com.bignerdranch.travelcommunity.videocache.Preconditions.checkNotNull(data);
    }
    ...
    public void append(byte[] newData, int length) throws ProxyCacheException {
        com.bignerdranch.travelcommunity.videocache.Preconditions.checkNotNull(data);
